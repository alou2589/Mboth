 ...
 */
class getTypeArbreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeArbreRepository' shared autowired service.
     *
     * @return \App\Repository\TypeArbreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeArbreRepository.php';

        return $container->privates['App\\Repository\\TypeArbreRepository'] = new \App\Repository\TypeArbreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
