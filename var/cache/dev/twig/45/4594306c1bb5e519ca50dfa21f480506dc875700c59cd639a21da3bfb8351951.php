...
class __TwigTemplate_1757942d510056351234a89d5ddd349ab39475c5bb259c3365a2d2842c93ec83 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  120 => 21,  115 => 19,  111 => 18,  105 => 17,  100 => 15,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
                    ...
                    <div class=\"col-lg-6 mx-auto\">
                        <div class=\"p-5\">
                            ...
                            <form method=\"post\" action=\"{{ path('app_eleve_delete', {'id': eleve.id}) }}\" onsubmit=\"return confirm(Êtes-vous sûr de vouloir effectuer cette action ?');\">
                                ...
                                <button class=\"btn btn-danger\">Delete <i class=\"fas fa-trash-alt\"></i></button>
                                <a href=\"{{ path('app_eleve_show', {'id':eleve.id}) }}\" class=\"btn btn-primary\">Accueil <i class=\"fas fa-home\"></i></a>
                            </form>
                        </div>
                    </div>
                </div>
...
{% endblock %}", "eleve/delete.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\BaseMboth\\templates\\eleve\\delete.html.twig");
    }
}
