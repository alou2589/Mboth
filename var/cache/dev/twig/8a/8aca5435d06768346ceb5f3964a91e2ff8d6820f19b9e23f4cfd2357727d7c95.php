...
class __TwigTemplate_9e1943ee40d77999053d260e162c53f8747964dd46f38c3478a02eecd958fbc6 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"col-md-12 col-sm-12 \">
    <div class=\"x_panel\">
      ...
      <div class=\"x_content\">
        ...
        echo "\" onsubmit=\"return confirm(Êtes-vous sûr de vouloir supprimer cet Point Focal ?');\">
                          ...
                          <div class=\"row\">
                            <div class=\"col-lg-10 mx-auto\">
                              <div class=\"p-5\">
                                ...
                                <form method=\"post\" action=\"{{ path('app_user_delete', {'id': user.id}) }}\" onsubmit=\"return confirm(Êtes-vous sûr de vouloir supprimer cet Point Focal ?');\">
...
{% endblock %}", "user/delete.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\Projets\\Mboth\\templates\\user\\delete.html.twig");
    }
}
