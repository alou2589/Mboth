...
/* user/edit.html.twig */
class __TwigTemplate_9c0221848dc4ba084dba773a0839485cbd553a48e9df2368459f27d0d43db2c1 extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"x_content\">
        ...
        echo "
                                    <div class=\"form-check form-switch\">
                                        ";
        // line 42
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 42, $this->source); })()), "active", [], "any", false, false, false, 42), 'row', ["attr" => ["class" => "form-check-input", "role" => "switch", "id" => "flexSwitchCheckChecked", "required" => "required", "checked" => "checked"]]);
        echo "                                             
                                    </div>
                                    <div class=\"form-floating mb-3\">
                                        ";
        // line 45
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 45, $this->source); })()), "username", [], "any", false, false, false, 45), 'row', ["attr" => ["class" => "form-control", "id" => "floatingInput", "placeholder" => "Nom d'Point Focal", "autocomplete" => "email", "required" => "required", "autofocus" => "autofocus"]]);
        echo "
                                    </div>
                                    <div class=\"form-floating mb-3\">
                                        ";
        ...
        echo "
                                    ...
                                    <div class=\"form-floating mb-3\">
                                        ";
        // line 51
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 51, $this->source); })()), "password", [], "any", false, false, false, 51), 'row', ["value" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 51, $this->source); })()), "password", [], "any", false, false, false, 51), "attr" => ["class" => "form-control", "id" => "floatingInput", "placeholder" => "Adresse email", "readonly" => "readonly", "required" => "required"]]);
        echo "
                                    </div>
...
";
    ...
    {
        return array (  159 => 56,  151 => 51,  145 => 48,  139 => 45,  133 => 42,  128 => 40,  101 => 16,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
                            ...
                            <div class=\"col-lg-10 mx-auto\">
                              <div class=\"p-5\">
                                {{form_start(form, {'attr':{'class':'form'}})}}
                                    <div class=\"form-check form-switch\">
                                        {{form_row(form.active, {'attr':{'class':\"form-check-input\",'role':\"switch\", 'id':\"flexSwitchCheckChecked\",'required':\"required\", 'checked':\"checked\"}})}}                                             
                                    </div>
                                    <div class=\"form-floating mb-3\">
                                        {{form_row(form.username, {'attr':{'class':\"form-control\", 'id':\"floatingInput\", 'placeholder':\"Nom d'Point Focal\", 'autocomplete':\"email\", 'required':\"required\", 'autofocus':\"autofocus\"}})}}
                                    </div>
                                    <div class=\"form-floating mb-3\">
                                    ...
                                    <div class=\"form-floating mb-3\">
                                        {{form_row(form.password, {'value': user.password,'attr':{'class':\"form-control\", 'id':\"floatingInput\", 'placeholder':\"Adresse email\", 'readonly':\"readonly\", 'required':\"required\"}})}}
                                    </div>
                                    <div class=\"form-group\">
                                        <button type=\"submit\" class=\"btn btn-warning\">Modifier <i class=\"fas fa-edit\"></i></button>
                                    </div>
...
{% endblock %}
", "user/edit.html.twig", "C:\\Users\\Alou\\Desktop\\projets\\Mboth\\templates\\user\\edit.html.twig");
    }
}
