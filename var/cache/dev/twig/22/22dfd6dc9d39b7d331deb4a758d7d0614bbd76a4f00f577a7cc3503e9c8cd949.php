...
class __TwigTemplate_579151d3ad709ad7a0124cdf3140801ce2d4a12f63ae9a3d3f8447315996b31e extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"card shadow mb-4\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["eleve"]) {
            ...
            // line 32
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["eleve"], "id", [], "any", false, false, false, 32), "html", null, true);
            echo "</td>
                            <td class=\"text-center\">";
            // line 33
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["eleve"], "personne", [], "any", false, false, false, 33), "prenom", [], "any", false, false, false, 33), "html", null, true);
            echo " ";
            ...
            echo "</td>
                            <td class=\"text-center\">";
            // line 34
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["eleve"], "ecole", [], "any", false, false, false, 34), "NomEcole", [], "any", false, false, false, 34), "html", null, true);
            echo "</td>
                            <td class=\"text-center\">";
            // line 35
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["eleve"], "classe", [], "any", false, false, false, 35), "NomClasse", [], "any", false, false, false, 35), "html", null, true);
            echo "</td>
                            <td class=\"text-center\">";
            // line 36
            ((twig_get_attribute($this->env, $this->source, $context["eleve"], "updatedAt", [], "any", false, false, false, 36)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["eleve"], "updatedAt", [], "any", false, false, false, 36), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                            <td class=\"text-center\">";
            // line 37
            ((twig_get_attribute($this->env, $this->source, $context["eleve"], "createdAt", [], "any", false, false, false, 37)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["eleve"], "createdAt", [], "any", false, false, false, 37), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                            <td class=\"text-center\">
                                <a href=\"";
            // line 39
...
";
    ...
    {
        return array (  171 => 47,  162 => 43,  153 => 39,  148 => 37,  144 => 36,  140 => 35,  136 => 34,  130 => 33,  126 => 32,  123 => 31,  118 => 30,  97 => 12,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "eleve/index.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\BaseMboth\\templates\\eleve\\index.html.twig");
    }
}
