...
class __TwigTemplate_1e5ecce6f0129dbe9fdda3c7d8ae3ebc8151229e5019c65aebadbac05aa76981 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
      ...
      <div class=\"col-md-12 col-sm-12 \">
        ...
        echo "\" class=\"text-decoration-none float-left m-1\" title=\"Ajout Secteur\"><i class=\"fas fa-plus-circle text-success\"></i></a>
                </li>
                <li>
                    <a class=\"collapse-link\" href=\"";
        // line 28
                ...
                <div class=\"col-sm-12\">
                    <div class=\"card-box table-responsive\">
                        <p class=\"text-muted font-13 m-b-30\">
                          Secteur ";
        // line 41
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 41, $this->source); })()), "NomSecteur", [], "any", false, false, false, 41), "html", null, true);
        echo ".
                        </p>
                        <div class=\"card\">
                            <div class=\"card-body\">
                                                        ...
                                                        <div class=\"p-1\">
                                                            <ul class=\"list-group\">
                                                                <li class=\"list-group-item\">
                                                                    <p><strong>Id</strong>: ";
        // line 54
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 54, $this->source); })()), "id", [], "any", false, false, false, 54), "html", null, true);
        echo "</p>
                                                                </li>
                                                                <li class=\"list-group-item\">
                                                                    <p><strong>Secteur</strong>: ";
        // line 57
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 57, $this->source); })()), "NomSecteur", [], "any", false, false, false, 57), "html", null, true);
        echo "</p>
                                                                </li>
                                                                <li class=\"list-group-item\">
                                                                    <p><strong>Cellule</strong>: ";
        // line 60
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 60, $this->source); })()), "cellule", [], "any", false, false, false, 60), "NomCellule", [], "any", false, false, false, 60), "html", null, true);
        echo "</p>
                                                                </li>
                                                                <li class=\"list-group-item\">
                                                                    <p>
                                                                        ...
                                                                        <a href=\"";
        // line 65
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_secteur_personnes", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 65, $this->source); })()), "id", [], "any", false, false, false, 65)]), "html", null, true);
        echo "\" class=\"text-decoration-none\" title=\"Liste Personnes\"><i class=\"fas fa-users text-info\"></i> </a>
                                                                        <a href=\"";
        // line 66
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_secteur_education", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["secteur"]) || array_key_exists("secteur", $context) ? $context["secteur"] : (function () { throw new RuntimeError('Variable "secteur" does not exist.', 66, $this->source); })()), "id", [], "any", false, false, false, 66)]), "html", null, true);
...
";
    ...
    {
        return array (  181 => 66,  177 => 65,  169 => 60,  163 => 57,  157 => 54,  141 => 41,  125 => 28,  119 => 25,  113 => 22,  107 => 19,  101 => 16,  89 => 6,  79 => 5,  59 => 3,  36 => 1,);
    }
        ...
        <div class=\"x_panel\">
          <div class=\"x_title\">
            ...
            <ul class=\"nav navbar-right panel_toolbox\">
                ...
                <li>
                    <a class=\"collapse-link\" href=\"{{ path('app_secteur_new') }}\" class=\"text-decoration-none float-left m-1\" title=\"Ajout Secteur\"><i class=\"fas fa-plus-circle text-success\"></i></a>
                </li>
                <li>
...
{% endblock %}
", "secteur/show.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\Projets\\MbothDataBase\\templates\\secteur\\show.html.twig");
    }
}
