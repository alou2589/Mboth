...
/* user/edit.html.twig */
class __TwigTemplate_7cc5fff8b542de3740609592efae7c25e2e716b73b9192845207288f9318f67a extends Template
{
    private $source;
    private $macros = [];
      ...
      <div class=\"x_content\">
        ...
        echo "
                                        ...
                                        <div class=\"form-floating mb-3\">
                                            ";
        // line 54
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 54, $this->source); })()), "password", [], "any", false, false, false, 54), 'row', ["attr" => ["value" => twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 54, $this->source); })()), "password", [], "any", false, false, false, 54), "class" => "form-control", "id" => "floatingInput", "placeholder" => "Adresse email", "readonly" => "readonly", "required" => "required"]]);
        echo "
                                        </div>
                            ...
                            <div class=\"col-lg-10 mx-auto\">
                              <div class=\"p-5\">
                                {{form_start(form, {'attr':{'class':'form'}})}}
                                        <div class=\"\">
                                            {{form_row(form.active, {'attr':{'class':\"js-switch\",'type':\"checkbox\"}})}}                                    
                                        </div>
                                            <div class=\"form-floating mb-3\">
                                        ...
                                        <div class=\"form-floating mb-3\">
                                            {{form_row(form.password, {'attr':{'value':user.password,'class':\"form-control\", 'id':\"floatingInput\", 'placeholder':\"Adresse email\", 'readonly':\"readonly\", 'required':\"required\"}})}}
                                        </div>
                                    <div class=\"form-group\">
                                        <button type=\"submit\" class=\"btn btn-warning\">Modifier <i class=\"fas fa-edit\"></i></button>
                                    </div>
...
{% endblock %}
", "user/edit.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\Projets\\MbothDataBase\\templates\\user\\edit.html.twig");
    }
}
