...
/* eleve/new.html.twig */
class __TwigTemplate_5234c0cdde05c86a4164de243f01236aa02cacc185fae9388771ae074ebfee94 extends Template
{
    private $source;
    private $macros = [];
                    ...
                    <div class=\"col-lg-6 mx-auto\">
                        <div class=\"p-5\">
                            ...
                            {{form_start(form, {'attr':{'class':'form'}})}}
                                ...
                                <div class=\"form-group\">
                                    <button type=\"submit\" class=\"btn bg-gradient-success text-white\">Valider <i class=\"fas fa-save\"></i> </button>
                                    <a href=\"{{ path('app_eleve_index') }}\" class=\"btn bg-gradient-secondary text-white\">Accueil <i class=\"fas fa-home\"></i></a>
                                </div>
                            {{ form_end(form) }}
                        </div>
                    </div>
...
", "eleve/new.html.twig", "C:\\Users\\Alou\\OneDrive\\Desktop\\BaseMboth\\templates\\eleve\\new.html.twig");
    }
}
