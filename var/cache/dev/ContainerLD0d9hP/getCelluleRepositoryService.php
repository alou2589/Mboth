 ...
 */
class getCelluleRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CelluleRepository' shared autowired service.
     *
     * @return \App\Repository\CelluleRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CelluleRepository.php';

        return $container->privates['App\\Repository\\CelluleRepository'] = new \App\Repository\CelluleRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
