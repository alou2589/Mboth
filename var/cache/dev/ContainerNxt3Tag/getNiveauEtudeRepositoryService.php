 ...
 */
class getNiveauEtudeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\NiveauEtudeRepository' shared autowired service.
     *
     * @return \App\Repository\NiveauEtudeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'NiveauEtudeRepository.php';

        return $container->privates['App\\Repository\\NiveauEtudeRepository'] = new \App\Repository\NiveauEtudeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
