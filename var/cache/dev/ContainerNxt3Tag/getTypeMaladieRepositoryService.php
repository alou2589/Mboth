 ...
 */
class getTypeMaladieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeMaladieRepository' shared autowired service.
     *
     * @return \App\Repository\TypeMaladieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeMaladieRepository.php';

        return $container->privates['App\\Repository\\TypeMaladieRepository'] = new \App\Repository\TypeMaladieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
