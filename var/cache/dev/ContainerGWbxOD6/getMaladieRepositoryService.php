 ...
 */
class getMaladieRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MaladieRepository' shared autowired service.
     *
     * @return \App\Repository\MaladieRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MaladieRepository.php';

        return $container->privates['App\\Repository\\MaladieRepository'] = new \App\Repository\MaladieRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
