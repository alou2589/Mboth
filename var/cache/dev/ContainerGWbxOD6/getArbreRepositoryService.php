 ...
 */
class getArbreRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ArbreRepository' shared autowired service.
     *
     * @return \App\Repository\ArbreRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ArbreRepository.php';

        return $container->privates['App\\Repository\\ArbreRepository'] = new \App\Repository\ArbreRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
