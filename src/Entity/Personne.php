...
class Personne
{
    ...
    #[ORM\ManyToOne(targetEntity: Maison::class, inversedBy: 'personnes')]
    ...
    #[ORM\OneToMany(mappedBy: 'personne', targetEntity: User::class, orphanRemoval: true)]
    private $users;
